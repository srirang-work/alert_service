...
SECRET_KEY = 'django-insecure-x6j_$ti1e^47&(dcpyizd@cxm4dz@qf#8@=3t@t+b)&*nece5&'
...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt.token_blacklist',  # Add this line for Django REST Framework Simple JWT
    'alert',
]
